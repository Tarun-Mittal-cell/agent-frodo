...
// Dynamically import the PricingModel with no SSR
const PricingModel = dynamic(() => import("@/components/custom/PricingModel"), {
  ssr: false,
  loading: () => (
    <div className="text-center py-5">Loading pricing options...</div>
  ),
});
...
function Pricing() {
  ...
  return (
    <div className="mt-10 flex flex-col items-center w-full p-10 md:px-32 lg:px-48">
      ...
      <Suspense
        fallback={
          <div className="text-center py-10">Loading pricing options...</div>
        }
      >
        <PricingModel />
      </Suspense>
